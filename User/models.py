...
class tbl_booking(models.Model):
    ...
    fromlocalplace=models.ForeignKey(tbl_localplace, on_delete=models.CASCADE,related_name="from_place")
    tolocalplace=models.ForeignKey(tbl_localplace, on_delete=models.CASCADE,related_name="to_place")

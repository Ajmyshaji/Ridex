...
def ajaxstar(request):
    ...
    tbl_rating.objects.create(user=tbl_user.objects.get(id=request.session['uid']),user_review=user_review,rating_data=rating_data,driver=tbl_driver.objects.get(id=pid))
